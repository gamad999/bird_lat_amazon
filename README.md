...
2.	Aplicación web móvil, cconsistente en un geovisor que integre la información del modelo de datos y facilite su consulta y exploración por parte de los usuarios por medio del despliegue de mapas digitales con imágenes satelitales de alta resolución, temas o capas de información de la base de datos mencionada y funcionalidades, enfocados en incentivar el interés y servir datos en la nube útiles para la realización de actividades ecoturisticas en el territorio, combinando las modalidades presencial y virtual en la interacción del viajero, las comunidades locales y las empresas con los recursos naturales y de biodiversidad propios de la región del Amazonas.
